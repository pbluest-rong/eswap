package com.ecoswap.features.mail;
    ...
    public String buildVerificationEmail(String code) {
        ...
        <div style="font-family: Arial, sans-serif; padding: 20px; background-color: #f4f4f4;">
            <div style="max-width: 600px; margin: auto; background: #ffffff; padding: 20px; border-radius: 8px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
                ...
                <p><b>Lưu ý:</b> Mã xác thực chỉ có hiệu lực trong vòng <span style="color: red;">1 phút</span> và chỉ sử dụng được <span style="color: red;">1 lần</span>.</p>
