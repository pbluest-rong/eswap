...
import 'package:eswap/core/dialogs/bottom_sheet.dart';
import 'package:eswap/core/dialogs/dialog.dart';
import 'package:eswap/core/widgets/search.dart';
...
import 'package:eswap/service/education_institution.dart';
import 'package:eswap/service/post_service.dart';
import 'package:eswap/view/home/category_chip_selector.dart';
import 'package:eswap/view/home/filter.dart';
                  ...
                  delegate: SliverChildBuilderDelegate(
                    (context, index) {
                      if (index < _allPosts.length) {
                        return _postService.buildPostItemHorizontal(
                          _allPosts[index],
                          context,
                        );
                      } else if (_hasMore) {
                    ...
                    (context, index) {
                      if (index < _allPosts.length) {
                        return Column(
                          ...
                          children: [
                            _postService.buildPostItem(
                                _allPosts[index], context),
                            Container(
                              height: 5,
