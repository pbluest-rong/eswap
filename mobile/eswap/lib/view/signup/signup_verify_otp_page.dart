...
class _VerifyOTPPageState extends State<SignupVerifyOTPPage> {
  ...
  Future<void> signup() async {
    ...
    try {
      if (signupProvider.isPhoneNumber) {
        const url = ServerInfo.register_phone_url;
        ...
        const url = ServerInfo.register_email_url;
        Provider.of<SignupProvider>(context, listen: false)
                          ...
                          text: TextSpan(
                            ...
                            children: [
                              Provider.of<SignupProvider>(context, listen: true)
                                      .isPhoneNumber
                                  ? TextSpan(
                                      text: "signup_verify_desc_head".tr(args: ["phone_number".tr()]))
                                  : TextSpan(
                                      text: "signup_verify_desc_head".tr(args: ["email".tr()])),
                              TextSpan(
