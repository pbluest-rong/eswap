...
class StorePostsPage extends StatefulWidget {
  static const String route = '/post-on-stores';

  const StorePostsPage({super.key});

  @override
  State<StorePostsPage> createState() => _StorePostsPageState();
}

class _StorePostsPageState extends State<StorePostsPage>
  ...
  Future<void> _loadInitialPosts() async {
    ...
    try {
      final postpage = await _postService.fetchStorePosts(
        _currentPage,
        _pageSize,
        context,
      );
